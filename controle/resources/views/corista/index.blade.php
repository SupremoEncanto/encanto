...
<div class="col-lg-12 panel-base">
    <div class="panel panel-grey">
        <div class="panel-heading">Lista dos Coristas <span class="label"><strong>{{ $coristas->total() . " corista(s)" }}</strong></span><span class="pull-right"><a class="text-blue" type="button" data-toggle="modal" data-target="#coristaCreate"><i class="fa fa-plus"></i></a>&nbsp;&nbsp;</span></div>
